        ...
        <form onsubmit="event.preventDefault(); verifRegis(this);" id="formRegis">                           
            ...
            <div class="form-outline form-white m-4">
                <input style="background-color: #9cbfdd;" type="text" id="typeUsernameX" class="fs-3 mb-1 form-control form-control-lg"
                    ...
                    <p class="row text-start fs-6 m-0 pt-0 lh-1" id="error-nomR" style="color: rgb(182 190 197 / 80%); display: none;">Debe ser menor a 15 caracteres</p>
                    <p class="row text-start fs-6 m-0 pt-0 lh-1" id="error-nomRe" style="color: rgb(182 190 197 / 80%); display: none;">Nombre ya registrado, elige otro</p>
                <input style="background-color: #9cbfdd;" type="email" id="typeEmailX" class="fs-3 mb-1 form-control form-control-lg"
                    ...
                    <p class="row text-start fs-6 m-0 pt-0 lh-1" id="error-emailR" style="color: rgb(182 190 197 / 80%); display: none;">No cumple con formato mail</p>
                    <p class="row text-start fs-6 m-0 pt-0 lh-1" id="error-emailRe" style="color: rgb(182 190 197 / 80%); display: none;">Mail ya registrado, elige otro</p>
                <input style="background-color: #9cbfdd;" type="password" id="typePasswordX" class="fs-3 mb-1 form-control form-control-lg"
                    ...
                    <p class="row text-start fs-6 m-0 pt-0 lh-1" id="error-passR" style="color: rgb(182 190 197 / 80%); display: none;">Debe ser menor a 20 caracteres, alfanumerico y al menos 3 caracteres especiales</p>
