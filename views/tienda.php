...
<?php if(!empty($user) && $user['esMod']){?>
    ...
    <form action="modelos/crear-oferta.php" enctype="multipart/form-data" method="POST" class="d-none d-flex w-100 flex-wrap" id="formOferta">
        <div class="w-50">
            ...
            <input type="datetime" name="productoBaja" placeholder="Establecer fecha baja del producto (Ej:2020-10-22 00:00:00)" class="form-control my-3" pattern="\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}">
        </div>
