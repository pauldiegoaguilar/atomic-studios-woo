...
<body class="overflow-x-hidden">
    ...
    <div class="d-flex flex-column align-items-center justify-content-center py-3" style="background-color: #1B191B; width: 100%;">
        ...
        <div class="d-flex justify-content-center w-50 py-2" style="margin: 20px 0;">
            <a class="text-white lead" href="?section=aviso-de-privacidad" style="margin-left: 25px; margin-right: 25px; text-decoration: none;">AVISO DE PRIVACIDAD</a>
            <a class="text-white lead" href="?section=terminos-de-servicio" style="margin-left: 25px; margin-right: 25px; text-decoration: none;">TERMINOS DE SERVICIO</a>
        </div>
