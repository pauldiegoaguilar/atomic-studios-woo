                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <a style="color: #013c70; font-size: 21px;" class="text-decoration-none" href="registro.html">Registrate Ahora</a>
                                    <a style="color: #013c70; font-size: 21px;" class="text-decoration-none " href="recuperar.html">¿Olvidaste tu contraseña?</a>
                                </div>

                                <!-- Checkbox -->
                                <div class="form-check d-flex justify-content-start mb-4">
                                    <input style="margin-right: 10px; margin-top: 0px; margin-left: -25px; background-color: #9cbfdd; border-radius: 5px; font-size: 40px;" class="form-check-input" type="checkbox" value=""
                                        id="form1Example3" />
